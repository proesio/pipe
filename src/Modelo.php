...
abstract class Modelo
{
     ...
     * 
     * @return \PIPE\ConstructorConsulta
     */
    ...
    /**
     * Obtiene el nombre de la conexión definida.
     *
     * @return string
     */
    public static function obtenerConexion()
    {
        ...
        return $propiedadesClase['conexion'];
    }

    /**
     * Obtiene el nombre de la tabla definida.
     *
     * @return string
     */
    public static function obtenerTabla()
    {
        ...
        return $propiedadesClase['tabla'];
    }

    /**
     * Obtiene el nombre de la llave primaria definida.
     *
     * @return string
     */
    public static function obtenerLlavePrimaria()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['llavePrimaria'];
    }

    /**
     * Obtiene el registro del tiempo definido.
     *
     * @return string
     */
    public static function obtenerRegistroTiempo()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['registroTiempo'];
    }

    /**
     * Obtiene el nombre del campo para el registro del tiempo de creación.
     *
     * @return string
     */
    public static function obtenerCreadoEn()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['creadoEn'];
    }

    /**
     * Obtiene el nombre del campo para el registro del tiempo de actualización.
     *
     * @return string
     */
    public static function obtenerActualizadoEn()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['actualizadoEn'];
    }

    /**
     * Obtiene el nombre del campo para el registro del tiempo de eliminación.
     *
     * @return string
     */
    public static function obtenerEliminadoEn()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['eliminadoEn'];
    }

    /**
     * Obtiene la eliminación suave definida.
     *
     * @return string
     */
    public static function obtenerEliminacionSuave()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['eliminacionSuave'];
    }

    /**
     * Obtiene los datos de la relación tieneUno.
     *
     * @return string|array
     */
    public static function obtenerTieneUno()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['tieneUno'];
    }

    /**
     * Obtiene los datos de la relación tieneMuchos.
     *
     * @return string|array
     */
    public static function obtenerTieneMuchos()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['tieneMuchos'];
    }

    /**
     * Obtiene los datos de la relación perteneceAUno.
     *
     * @return string|array
     */
    public static function obtenerPerteneceAUno()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['perteneceAUno'];
    }

    /**
     * Obtiene los datos de la relación perteneceAMuchos.
     *
     * @return string|array
     */
    public static function obtenerPerteneceAMuchos()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['perteneceAMuchos'];
    }

    /**
     * Obtiene los campos insertables.
     *
     * @return array
     */
    public static function obtenerInsertables()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['insertables'];
    }

    /**
     * Obtiene los campos actualizables.
     *
     * @return array
     */
    public static function obtenerActualizables()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        return $propiedadesClase['actualizables'];
    }
    ...
    public static function obtenerVisibles()
    {
        ...
        return $propiedadesClase['visibles'];
    }

    /**
     * Obtiene los campos ocultos.
     *
     * @return array
     */
    public static function obtenerOcultos()
    {
        ...
        return $propiedadesClase['ocultos'];
    }

    /**
     * Obtiene las propiedades definidas en el modelo.
     *
     * @return array
     */
    public static function obtenerPropiedadesModelo()
    {
        $propiedadesClase = self::obtenerPropiedadesClase(get_called_class());

        unset($propiedadesClase['claseLlamada']);
        unset($propiedadesClase['clase']);

        return $propiedadesClase;
    }
