...
class SQLServer
{
    ...
    public static function migrar()
    {
        ...
        Migracion::tabla('telefonos')
            ...
            ->enteroGrande('numero', (new Atributo)->nulo())
            ->fechaHora2('creado_en', (new Atributo)->nulo())
            ->fechaHora2('actualizado_en', (new Atributo)->nulo())
            ->fechaHora2('eliminado_en', (new Atributo)->nulo())
            ->crearTabla();
        ...
        Migracion::tabla('usuarios')
            ...
            ->fechaHora2('actualizado_en', (new Atributo)->nulo())
            ->fechaHora2('eliminado_en', (new Atributo)->nulo())
            ->llaveForanea('telefono_id', 'telefonos', 'id', null, Atributo::CASCADA)
            ->crearTabla();
        ...
        Migracion::tabla('temas')
            ...
            ->fechaHora2('actualizado_en', (new Atributo)->nulo())
            ->fechaHora2('eliminado_en', (new Atributo)->nulo())
            ->llaveForanea('usuario_id', 'usuarios', 'id', null, Atributo::CASCADA)
            ->crearTabla();

        Migracion::tabla('role_usuario')
            ->entero('role_id', (new Atributo)->noNulo())
            ->entero('usuario_id', (new Atributo)->noNulo())
            ->llaveForanea('role_id', 'roles', 'id', null, Atributo::CASCADA)
            ->llaveForanea('usuario_id', 'usuarios', 'id', null, Atributo::CASCADA)
            ->crearTabla();
